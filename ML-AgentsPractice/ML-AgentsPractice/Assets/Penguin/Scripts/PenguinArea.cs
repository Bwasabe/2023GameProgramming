...
public class PenguinArea : MonoBehaviour
{
    ...
    public GameObject _babyPenguin;
    ...
    {
        Rigidbody rigidbody = _babyPenguin.GetComponent<Rigidbody>();
        rigidbody.velocity = Vector3.zero;
        rigidbody.angularVelocity = Vector3.zero;
        
        _babyPenguin.transform.position = ChooseRandomPosition(transform.position, -45f, 45f, 4f, 9f) + Vector3.up * .5f;
        _babyPenguin.transform.rotation = Quaternion.Euler(0f,180f, 0f);
    }
